...
select a.emp_no as '사번', a.first_name as '이름', e.salary as '연봉', b.title as '직책', d.dept_name as '부서'
...
select concat(first_name, ' ', last_name) as '이름',c.dept_name as '부서명', b.title as '직책'
...
select a.title as '직책', b.salary '급여'
...
select a.dept_no as '부서번호', avg(salary) as '평균연봉'
